...
class NotficPackageScreen extends StatefulWidget {
  @override
  _NotficPackageScreenState createState() => _NotficPackageScreenState();
}

class _NotficPackageScreenState extends State<NotficPackageScreen> with WidgetsBindingObserver {
